...
\documentclass[a4paper, 11pt, oneside, draft]{memoir}
\usepackage{vhistory}
\usepackage{comment}
\usepackage{gensymb}
\usepackage{datetime}
...
%\usepackage{mathptmx}  % Sets a Times-like font without fontspec
...
%%	\renewcommand\printcthaptertitle[1]{\color{gray}\chaptitlefont\raggedleft ##1\par}
%	} 
%\makeatother 
%\chapterstyle{daleifmodif}
\makeatletter
\renewcommand{\@makechapterhead}[1]{%
	\vspace*{50pt} % Adjust vertical space before the chapter title
	{\parindent \z@ \raggedleft\textcolor{RedOrange}{\normalfont\Huge \scshape Chapter\bfseries~\thechapter} \par} % "Chapter" in non-bold before number
	{\parindent \z@ \raggedleft \normalfont\Huge\bfseries\scshape #1\par} % Chapter title in bold on a separate line
	\vspace{10pt} % Adjust vertical space after the chapter title
}
\makeatother
...
% color configuration
\usepackage[colorlinks=true, allcolors=RedOrange]{hyperref}          %Creates hyperlinks in cross references
...
\definecolor{foreground}{HTML}{24292E}
\definecolor{comment}{HTML}{6A737D}
\definecolor{string}{HTML}{032F62}
\definecolor{keyword}{HTML}{990000}
\definecolor{number}{HTML}{005CC5}
...
\lstset{xleftmargin=15pt,xrightmargin=5pt}
...
\begin{document}
	...
	\input{frontmatter/terminologies}
%	\maketitle
	\clearpage
	\tableofcontents*
	\clearpage
...
%	\clearpage
	...
	\import{chapters/ch-01/}{chap_1} % Background
	\import{chapters/ch-02/}{chap_2} % Project Framework
	\part{Requirements}
	\import{chapters/ch-03/}{chap_3} % Requirements Elicitation
	\import{chapters/ch-03/}{chap_3_1}
	\part{Design and Development}
	\import{chapters/ch-04/}{chap_4} % System Design
	\import{chapters/ch-05/}{chap_5} % Implementation
	\part{Test and Evaluation}
	\import{chapters/ch-06/}{chap_6} % Evaluation of outcomes
	\import{chapters/ch-07/}{chap_7} % Conclusion
	
%	\includegraphics[width=0.4\textwidth]{frontmatter/KMUTT_CI.png}
%	
	\backmatter
	\printindex
