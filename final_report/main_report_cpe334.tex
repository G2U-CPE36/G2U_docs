...
\renewcommand{\@makechapterhead}[1]{%
	...
	{\parindent \z@ \raggedleft\textcolor{RedOrange}{\normalfont\Huge \scshape Chapter\textbf{~\thechapter}} \par} % "Chapter" in non-bold before number
	{\parindent \z@ \raggedleft \normalfont\Huge\scshape \textbf{#1}\par} % Chapter title in bold on a separate line
